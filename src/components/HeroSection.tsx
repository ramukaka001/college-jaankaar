          ...
          <div className="space-y-4">
            ...
            <AnimatedSection animation="slideUp" delay={0.4}>
              <h1 className="text-2xl md:text-4xl lg:text-5xl font-heading font-bold text-white leading-tight">
                Your Trusted
                <span className="block text-3xl md:text-5xl lg:text-6xl bg-gradient-to-r from-primary-400 to-secondary-400 bg-clip-text text-transparent font-bold">
                  Partner for
                </span>
                <span className="block text-2xl md:text-4xl lg:text-5xl text-neutral-200">
                  Government College Admissions in India
                </span>
              </h1>
            </AnimatedSection>
            ...
            <AnimatedSection animation="slideUp" delay={0.6}>
              <p className="text-xl text-neutral-300 leading-relaxed max-w-2xl">
                Expert counselling and admission assistance for CUET, IISER, Central & State Universities – All
                in one place.
              </p>
            </AnimatedSection>
